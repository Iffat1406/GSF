          ...
          <div className="md:col-span-2 space-y-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter"
                className="size-9 rounded-lg flex items-center justify-center transition-all hover:scale-110 border border-[var(--border-default)] bg-[var(--bg-surface)] shadow-soft-sm text-[var(--text-muted)]"
              >
